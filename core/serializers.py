...
class SignUpSerializer(serializers.Serializer):
    ...
    def sign_up(self):
        ...
        with transaction.atomic():
            user = User.objects.create_user(username=username, **self.validated_data)
                
        return JsonResponse(data={'user_id': user.id}, message="User creation success")
...
class LoginSerializer(serializers.Serializer):
    ...
    def login(self):
        ...
        data = {'refresh': str(token), 'access': str(token.access_token), 'user_id': user.id, 'username': user.username}
    ...
    def update(self, instance, validated_data):
        ...
        with transaction.atomic():
            if user:
                ...
                return JsonResponse(data={'user_id': user.id}, message="Updated user successfully")
