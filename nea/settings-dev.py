...
SECRET_KEY = 'yt1h11rr48rcrc%k*js_p%8-a$v$$n$buh^20bz61%h1kgn2sn'
...
# DATABASES = {'default': dj_database_url.config(default='postgres://neaadmin:neaadmin@localhost:5432/neadb')}
